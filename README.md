...
<h1>HumanGif: Single-View Human Diffusion with Generative Prior</h1>
...
<div style="width: 70%; text-align: center; margin:auto;">
    <img style="width:100%" src="assets_img/HumanGif_vis.gif"><br>
    <em>HumanGif learns a single-view human diffusion with generative prior.</em>
</div>

:open_book: For more visual results, go checkout our <a href="https://skhu101.github.io/HumanGif" target="_blank">project page</a>

This repository will contain the official implementation of _HumanGif: Single-View Human Diffusion with Generative Prior_.
